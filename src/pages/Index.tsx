        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <div className="flex justify-center mb-8 opacity-0 animate-fade-in">
            <div className="relative">
              ...
              <img src="/lovable-uploads/fbe5d1f1-a35b-47a7-8c54-80c47f04a9e1.png" alt="WEBCAPZ Technologies Logo" className="relative h-24 w-auto object-contain drop-shadow-2xl" />
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto opacity-0 animate-slide-up" style={{
          animationDelay: '0.2s'
        }}>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center opacity-0 animate-slide-up" style={{
          animationDelay: '0.3s'
        }}>
            <Link to="/auth">
      ...
      <div className="py-24 px-6 bg-secondary/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            desc: 'Manage instructors and departments'
          }, {
            icon: Award,
            title: 'Certificates',
            desc: 'Issue and verify digital certificates'
          }, {
            icon: Calendar,
            title: 'Scheduling',
            desc: 'Class schedules and attendance tracking'
          }].map((feature, i) => <div key={feature.title} className="glass-card rounded-2xl p-6 hover-lift group cursor-default">
      ...
      <footer className="py-8 px-6 border-t border-border">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/lovable-uploads/fbe5d1f1-a35b-47a7-8c54-80c47f04a9e1.png" alt="WEBCAPZ" className="h-8 w-auto" />
